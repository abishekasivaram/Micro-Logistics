...
const CustomerRegisterPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.fullName || !formData.username || !formData.email || !formData.password || !formData.phone || !formData.address) {
    ...
    <div className="auth-page-container">
      <div className="auth-card-wide">
        <div className="auth-header">
          ...
          <p>Join the hyper-local micro-logistics network to order fresh goods with coordinated delivery.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="auth-form-grid">
          ...
          <div className="form-group">
            ...
            >
              ...
              <option value="Besant Nagar, Chennai">Besant Nagar, Chennai</option>
            </select>
          </div>
          ...
          <div className="auth-actions-full full-width">
            <button type="submit" className="btn btn-primary btn-lg w-full">
              <UserCheck size={20} style={{ marginRight: '8px' }} /> Create Customer Account
            </button>
